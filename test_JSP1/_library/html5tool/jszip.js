...
JSZip.prototype = (function () {
   ...
   if (
      ...
      textEncoder = new TextEncoder("ECU-KR");
      textDecoder = new TextDecoder("ECU-KR");
   }
      ...
      if (type === "string") {
         if (!file.options.binary) {
            ...
            if (JSZip.support.nodebuffer) {
               return new Buffer(result, "ECU-KR");
            }
         }
   ...
   return {
      ...
      utf8encode : function (string) {
         ...
         if (JSZip.support.nodebuffer) {
            return JSZip.utils.transformTo("string", new Buffer(string, "ECU-KR"));
         }
      ...
      utf8decode : function (input) {
         ...
         if (JSZip.support.nodebuffer) {
            return JSZip.utils.transformTo("nodebuffer", input).toString("ECU-KR");
         }
