...
<%@page import="org.apache.poi.openxml4j.exceptions.NotOfficeXmlFileException"%>
<%@page import="org.apache.poi.openxml4j.exceptions.OLE2NotOfficeXmlFileException"%>
...
<%
	...
	Sheet sheet1 = wb.createSheet("Sheet1"); //필요한 시트 생성
	...
	String savePath = "//192.168.11.15/web10/TEST/_Test_JSP/test_JSP1.soobakc.com/Member/kimnewTEST1.xls";
   ...
   //   List<String> tmpData = Arrays.asList("Java", "JavaScript", "Python", "GoLang");
     ...
     // try (ByteArrayOutputStream fileOut = new ByteArrayOutputStream();FileOutputStream fos = new FileOutputStream(savePath);) {
